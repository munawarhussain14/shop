        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header card-header-primary">
                    <h4 class="card-title">{{($data??false)?"Edit":"Add"}} Brand</h4>
                    {{--<p class="card-category">Add New Category</p>--}}
                </div>
                <div class="card-body">
                    <form method="post" action="{{url((($data??false)?'brand/edit/'.$data->id:'brand/add'))}}" enctype="multipart/form-data">
                        @csrf
                        @if($data??false)
                            ...
                            <div class="col-md-12 col-sm-12">
                                ...
                                <div class="fileinput text-center fileinput-new" data-provides="fileinput">
                                    <div class="fileinput-new thumbnail">
                                        <img src="{{asset($data->logo_url??'assets/img/image_placeholder.jpg')}}" alt="...">
                                    </div>
